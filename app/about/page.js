        ...
        >
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="max-w-4xl">
              ...
              >
                Since 2019, we've been bridging language barriers and helping businesses expand globally. 
                ...
                <motion.div key={index} variants={itemVariants}>
                  <Card className="text-center  bg-white border border-black-subtle shadow-lg transition-smooth hover-lift">
                    <CardContent className="p-8">
                      <motion.div 
                        className="w-16 h-16 mt-6 bg-red-600 rounded-full flex items-center justify-center mx-auto mb-4"
              ...
              >
                ...
                <div className="space-y-6 text-black leading-relaxed">
                  <p className="text-black-subtle">
                    Founded in 2019 by a team of linguists and technology experts, Mozhi Solutions began 
              ...
              >
                ...
                >
                  <div className="text-center">
                    <div className="text-2xl font-bold text-red-500">2019</div>
