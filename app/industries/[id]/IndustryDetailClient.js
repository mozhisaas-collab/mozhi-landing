...
export function IndustryDetailClient({ industry, relatedPosts }) {
              ...
              <div className="lg:col-span-1">
                <div className="sticky top-24 space-y-6">
                  ...
                  >
                    <Card className="bg-gray-50 border-2 border-red-500">
                      <CardContent className="p-6">
                        <h3 className="text-xl font-bold mt-6 text-black">Get Industry-Specific Quote</h3>
                  ...
                  >
                    <Card className="bg-white border border-black/10">
                      <CardContent className="p-6">
                        <h3 className="text-xl font-bold mt-6 text-black">Industry Expertise</h3>
                ...
                {relatedPosts.slice(0, 3).map((post, index) => (
                  ...
                  >
                    <Card className="overflow-hidden bg-white border border-black/10 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg h-full flex flex-col">
                      ...
                      <CardContent className="p-6 flex flex-col mt-6 flex-1">
