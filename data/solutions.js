export const services = [
  ...
  {
    id: "digital-localization",
    title: "Digital Localization",
    shortDescription: "Comprehensive digital content localization for websites, apps, and online platforms",
    fullDescription: "Transform your digital presence for global markets with our comprehensive digital localization services. We localize websites, mobile apps, digital marketing content, and online platforms to ensure seamless user experiences across all digital touchpoints.",
    icon: "Monitor",
    features: [
    ...
    industries: ["E-commerce", "Technology", "Marketing", "Media & Entertainment"]
  },
  {
  ...
  {
    id: "mobile-app-localization",
    title: "Mobile App Localization",
    shortDescription: "Complete mobile application localization for iOS and Android platforms",
    fullDescription: "Expand your mobile app's reach globally with our comprehensive mobile app localization services. We localize your app's interface, content, and user experience while ensuring compliance with platform-specific requirements and cultural expectations.",
    icon: "Smartphone",
    features: [
    ...
    industries: ["Mobile Apps", "Gaming", "E-commerce", "Healthcare"]
  },
  {
